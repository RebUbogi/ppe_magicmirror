...
Module.register("MMM-SmartTouch", {
	...
	createShutdownButton: function () {
		...
		shutdownButtonItem.innerHTML = "<span class='fa fa-power-off fa-3x'></span>" + "<br>" + this.translate("SHUTDOWN");
		shutdownButtonItem.className = "li-t";

		// Send shutdown notification when clicked
		shutdownButtonItem.addEventListener("click", () => this.sendSocketNotification("SHUTDOWN", {}));
	...
	createRestartButton: function () {
		...
		restartButtonItem.innerHTML = "<span class='fa fa-repeat fa-3x'></span>" + "<br>" + this.translate("RESTART");
		restartButtonItem.className = "li-t";

		// Send restart notification when clicked
		restartButtonItem.addEventListener("click", () => this.sendSocketNotification("RESTART", {}));
